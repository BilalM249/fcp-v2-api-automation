@Sanity
Feature: Checkout with Bundle product Along with Single Use ALL SKU AMOUNT Off coupon

  Scenario: Checkout with Bundle product Along with Single Use ALL SKU AMOUNT Off coupon
    ...
    * def applyCoupon = call read('classpath:karate/core/cart/applyCoupon.feature@SingleLineItemUsedCoupon') {cartId: '#(cartId)', couponCode:'#(SINGLE_USED_COUPON)'}
