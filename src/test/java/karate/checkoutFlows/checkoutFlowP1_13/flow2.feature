@Sanity
Feature: Checkout with variant + Non Variant Item and cancel lineItem 1

  Background:
    * def sleep = function(millis){ java.lang.Thread.sleep(millis) }

  Scenario: Checkout with variant + Non Variant Item and cancel lineItem 1
    ...
    * def cancelOrder = call read('classpath:karate/core/oms/OrderCancel.feature@partialOrderCancel') {orderId : '#(orderId)', shipToId: '#(shipToId)',cartId: '#(cartId)', ItemId1: '#(ItemId1)' , ItemId2: '#(ItemId)', lineItemId: 1}