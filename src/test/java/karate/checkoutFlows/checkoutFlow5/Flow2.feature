...
Feature: Checkout with variant and Non Variant product with Coupon Exclude on  Non Variant Item
  ...
  Scenario:  Exclude on Non Variant Item and  Applied to Cart With Non Variant Item
    ...
    * def cart = call read('classpath:karate/core/cart/addToCart.feature@AddingMultipleItemToCart') {ItemId1: '#(ItemId1)', ItemAttributes1:'#(ItemId1Attributes)', ItemId2: '#(ItemId)', ItemAttributes2:'#(ItemAttributes)', ,InventoryChannelForItem2: '#(inventoryChannelForItem2)', InventoryChannelForItem1: '#(inventoryChannelForItem1)'}
