...
Feature: Checkout without Variant Promotion Quantity product
  ...
  Scenario: Quantity promotions and no coupons With Non Variant Item
    ...
    * def cart = call read('classpath:karate/core/cart/addToCart.feature@PromotionalCartWithSingleLineItemWithMultiPleQua') {ItemId: '#(ItemId)', ItemAttributes:'#(ItemAttributes)',  quantity:'2',InventoryChannelForItem1: '#(inventoryChannelForItem1)'}
